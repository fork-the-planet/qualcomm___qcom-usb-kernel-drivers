...
#define QCOM_FILTER_VERSION 1.0.1.5
#define QCOM_FILTER_FILE_VERSION 1,0,1,5
#define QCOM_FILTER_FILE_VERSION_STRING QCSTR(QCOM_FILTER_VERSION)

#define QCOM_NET_VERSION 5.0.1.1
#define QCOM_NET_FILE_VERSION 5,0,1,1
#define QCOM_NET_FILE_VERSION_STRING QCSTR(QCOM_NET_VERSION)

#define QCOM_WDFSERIAL_VERSION 1.0.3.6
#define QCOM_WDFSERIAL_FILE_VERSION 1,0,3,6
